  ...
  return (
    <section className='bg-[#F4F7FF] py-14 dark:bg-dark lg:py-20'>
      <div className='container px-4'>
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4'>
            <div className='mx-auto max-w-[525px] rounded-lg bg-white px-8 py-14 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]'>
              <div className='mb-10'>
                <Link href='/' className='mx-auto inline-block max-w-[160px]'>
                  <Image
                    src='/images/logo/logo.svg'
              ...
              <form onSubmit={handleSubmit}>
                <div className='mb-5'>
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className='w-full rounded-md border border-stroke bg-transparent px-5 py-3 text-base text-dark placeholder:text-dark-6 focus:border-primary dark:border-dark-3 dark:text-white dark:focus:border-primary'
                  />
                </div>
                <div className='mb-5'>
                  <input
                ...
                <div>
                  <button
                    type='submit'
                    className='flex w-full items-center justify-center rounded-md border border-primary bg-primary px-5 py-3 text-white hover:bg-blue-dark'>
                    Save Password {loader && <Loader />}
                  </button>
                </div>
              </form>
